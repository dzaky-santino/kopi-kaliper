...
if(isset($_GET['delete'])){
   ...
   $delete_order = $conn->prepare("DELETE FROM `pesanan` WHERE user_id = ?");
...
<section class="accounts">
   ...
   <div class="box">
      ...
      <p> Nama : <span><?= $fetch_accounts['nama']; ?></span> </p>
      <p> Email : <span><?= $fetch_accounts['email']; ?></span> </p>
      <p> Nomor HP : <span><?= $fetch_accounts['no_hp']; ?></span> </p>
      <p> Nomor Meja : <span><?= $fetch_accounts['no_meja']; ?></span> </p>
